...
export const metadata: Metadata = {
  title: "LinkedIn Strategy | AVI Industriel",
  description:
    "LinkedIn launch strategy for AVI Industriel: profile setup, content calendar, 12 ready-to-post pieces, and engagement tactics.",
};
    ...
    <main>
      ...
      <section className="bg-graphite grid-texture pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mt-4 text-steel-light text-lg">AVI Industriel Inc. | First 30 Days</p>
        </div>
      </section>
      ...
      <section className="bg-concrete py-20">
        <div className="mx-auto max-w-3xl px-6">
          <ScrollReveal>
            ...
            <p className="text-shop-grey text-sm mb-8">3 posts per week: Tuesday, Thursday, Saturday</p>
          </ScrollReveal>
