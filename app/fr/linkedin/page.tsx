    ...
    <main>
      ...
      <section className="bg-graphite grid-texture pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-bright md:text-6xl">Strategie de lancement LinkedIn</h1>
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <ScrollReveal delay={100}>
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border-light rounded-lg p-6">
                <p className="text-xs uppercase tracking-[0.15em] text-dust mb-3">Section A propos</p>
...
Machine down? Call me: (514) 971-1284`}</div>
              ...
              <div className="bg-white border border-border-light rounded-lg p-6">
                <p className="text-xs uppercase tracking-[0.15em] text-dust mb-2">Image de banniere</p>
                <p className="text-sm text-shop-grey">Fond graphite sombre avec logo AVI (contour vert) centre. Texte : &laquo;&nbsp;Diagnostic. Reparation. En marche.&nbsp;&raquo; en Inter bold. Correspond a l'esthetique du site web.</p>
              </div>
            </div>
          </ScrollReveal>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="text-shop-grey">
                  ...
                  <tr className="border-b border-border-light"><td className="py-3 px-4 font-mono text-signal">2</td><td className="py-3 px-4">Histoire de travail #1</td><td className="py-3 px-4">Capsule technique #2</td><td className="py-3 px-4">Disponibilite</td></tr>
                  <tr className="border-b border-border-light"><td className="py-3 px-4 font-mono text-signal">3</td><td className="py-3 px-4">Publication de credibilite</td><td className="py-3 px-4">Histoire de travail #2 (FR)</td><td className="py-3 px-4">Capsule technique #3</td></tr>
      ...
      {/* 3. Publications pretes */}
      <section className="bg-workshop py-20">
        <div className="mx-auto max-w-3xl px-6">
          <ScrollReveal>
            <p className="text-xs uppercase tracking-[0.15em] text-dust mb-2">03</p>
            <h2 className="text-3xl font-bold tracking-tight text-machine-black mb-8">12 publications pretes a publier</h2>
          </ScrollReveal>
      ...
      <section className="bg-graphite grid-texture py-20">
        <div className="mx-auto max-w-3xl px-6">
          <ScrollReveal>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-bright mb-8">Modeles de contenu</h2>
          </ScrollReveal>

          <div className="space-y-4">
            {[
              { title: "Travail complete", template: "[Enonce du probleme — une phrase, specifique]\n\n[Comment vous l'avez trouve — approche diagnostique, 2-3 phrases]\n\n[La solution — ce que vous avez fait, en combien de temps]\n\n[Conclusion — le pattern ou la lecon]\n\n(514) 971-1284" },
              { title: "Capsule technique", template: "[Accroche — fait surprenant ou erreur courante]\n\n[La liste — 3-5 elements specifiques et actionnables]\n\n[Conclusion — pourquoi c'est important / ce que ca sauve]\n\n[CTA souple — \"Questions? (514) 971-1284\"]" },
              { title: "Marque machine", template: "[Nom de la marque + opinion forte ou fait]\n\n[3-5 observations specifiques d'experience]\n\n[Fermeture — \"Je repare des [marque] depuis X ans. Si la votre agit mal, je sais probablement deja ce qui ne va pas.\"]\n\n(514) 971-1284" },
              { title: "Disponibilite", template: "[Fenetre de reservation — semaine prochaine, ce mois-ci]\n\n[Ce que vous offrez — service specifique]\n\n[Portee — marques, ce qui est inclus]\n\n[Une ligne — cadrage de prix ou \"tarification directe\"]\n\n(514) 971-1284" },
            ].map((t, i) => (
      ...
      {/* 5. Strategie d'engagement */}
      <section className="bg-workshop py-20">
        <div className="mx-auto max-w-3xl px-6">
          <ScrollReveal>
            <p className="text-xs uppercase tracking-[0.15em] text-dust mb-2">05</p>
            <h2 className="text-3xl font-bold tracking-tight text-machine-black mb-8">Strategie d'engagement</h2>
          </ScrollReveal>
          ...
          <ScrollReveal delay={100}>
            ...
            <div className="space-y-3 mb-10">
              {[
                { priority: "1", titles: "Directeur d'usine, Gestionnaire de maintenance, Superviseur de maintenance", why: "Ils approuvent les contrats de service" },
                { priority: "2", titles: "Operateur CNC, Technicien de machines", why: "Ils recommandent les fournisseurs aux gestionnaires" },
                { priority: "3", titles: "Gestionnaire des achats, Specialiste en approvisionnement", why: "Ils evaluent et negocient" },
                { priority: "4", titles: "Techniciens independants, outilleurs-ajusteurs", why: "Reseau de reference" },
              ].map((row) => (
          ...
          <ScrollReveal delay={200}>
            <h3 className="font-semibold text-machine-black mb-4">Groupes a rejoindre</h3>
          ...
          <ScrollReveal delay={300}>
            ...
            <div className="bg-white border border-border-light rounded-lg p-4">
              <p className="text-sm text-shop-grey italic">&laquo;&nbsp;Bonjour [nom] — je suis un technicien CNC independant a Montreal (20 ans, Makino/Mazak/Fanuc/Haas/Siemens). Je me connecte avec les professionnels du manufacturier dans la region. Au plaisir de connecter.&nbsp;&raquo;</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="bg-concrete py-20">
        <div className="mx-auto max-w-3xl px-6">
          <ScrollReveal>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-machine-black mb-8">KPIs — Premiers 90 jours</h2>
          </ScrollReveal>
          ...
          <ScrollReveal delay={100}>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border-light">
                    <th className="text-left py-3 px-4 font-semibold text-machine-black">Metrique</th>
          ...
          <ScrollReveal delay={200}>
            <div className="bg-white border border-border-light rounded-lg p-6 mt-8">
              <h3 className="font-semibold text-machine-black mb-2">A quoi ressemble le succes</h3>
              <p className="text-sm text-shop-grey leading-relaxed">Alexandre est reconnu dans la communaute manufacturiere LinkedIn de Montreal comme le gars CNC independant. Quand la machine de quelqu'un tombe en panne, ils ont soit vu ses publications, soit quelqu'un dans leur reseau le mentionne. Un seul travail de reparation d'urgence a $5 000+ provenant d'une connexion LinkedIn rembourse 6 mois d'effort de publication.</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
