...
export const metadata: Metadata = {
  title: "Stratégie LinkedIn | AVI Industriel",
  description:
    "Stratégie de lancement LinkedIn pour AVI Industriel : profil, calendrier de contenu, 12 publications et tactiques d'engagement.",
};
    ...
    <main>
      ...
      <section className="bg-graphite grid-texture pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mt-4 text-steel-light text-lg">AVI Industriel Inc. | Premiers 30 jours</p>
        </div>
      </section>
      ...
      <section className="bg-concrete py-20">
        <div className="mx-auto max-w-3xl px-6">
          <ScrollReveal>
            ...
            <p className="text-shop-grey text-sm mb-8">3 publications par semaine : mardi, jeudi, samedi</p>
          </ScrollReveal>
